...
<body class="d-flex align-items-center bg-primary">
    <div class="container col-md-7 col-12 rounded-lg px-md-5 pt-md-5 p-3 leftBorder">
        <?php
        $crumbs = [
        ...
        <div class="card px-5 pt-5 pb-4 shadow-sm">
            ...
            <form action="authenticate.php" method="POST" class=" needs-validation p-0 mb-4" novalidate>
                ...
                <div class="text-small mt-4">Set / Reset Password? <a class="text-danger d-block d-md-inline-block"
                        href="./resetPass.php">Click
                        here</a></div>
            </form>
        </div>
    </div>
