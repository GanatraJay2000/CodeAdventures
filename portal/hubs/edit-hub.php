                    ...
                    <div class="card p-5 sh-darker rounded-md border-0">
                        ...
                        <form class="row g-3" action="./actions/edit-hub.php" method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <input required type="text" value="<?= $hub['name'] ?>" name="hubName" class="form-control" id="hubName">
                            </div>
                            <div class="col-md-12">
                                <label for="detailedAddress" class="form-label">Detailed Address</label>
                                <input required type="text" value="<?= $hub['detailed_address']  ?>" name="detailedAddress" class="form-control" id="detailedAddress">
                            </div>
                            <div class="col-md-6">
                                <label for="town" class="form-label">Town</label>
                                <input required type="text" value="<?= $hub['town'] ?>" name="town" class="form-control" id="town">
                            </div>
                            <div class="col-md-6">
                                <label for="city" class="form-label">City</label>
                                <input required type="text" value="<?= $hub['city'] ?>" name="city" class="form-control" id="city">
                            </div>
                            <div class="col-md-12">
                                <label for="branchId" class="form-label">Branch Id</label>
                                <input type="text" value="<?= $hub['region_id'] ?>" name="branchId" class="form-control" id="branchId">
                            </div>
