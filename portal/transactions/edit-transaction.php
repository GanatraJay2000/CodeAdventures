                        ...
                        <form class="row g-3" action="./actions/edit-transaction.php" method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="serviceType" class="form-control" id="serviceType"
                                    value="<?= $transaction['service_type'] ?>">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="number" name="kmAllowances" class="form-control" id="kmAllowances"
                                    value="<?= $transaction['km_allowances'] ?>">
                            </div>
