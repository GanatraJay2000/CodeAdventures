                              ...
                              <div class="card p-5 sh-darker rounded-md border-0">
                                    ...
                                    <form class="row g-3" action="./actions/edit-zone.php" method="POST">
                                          ...
                                          <div class="col-md-12">
                                                ...
                                                <input required type="text" value="<?= $zone['name'] ?>" name="zoneName" class="form-control" id="zoneName">
                                          </div>
                                          <div class="col-md-12">
                                                <label for="branchId" class="form-label">Branch Id</label>
                                                <input type="text" name="branchId" class="form-control" id="branchId" value="<?= $zone['main_branch_id'] ?>">
                                          </div>
